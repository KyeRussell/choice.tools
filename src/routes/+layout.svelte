...
>
	<header class="px-4 py-2 text-center md:py-4 md:px-20">
		<h1 class="flex-grow font-['Roboto_Slab'] text-5xl font-bold md:text-8xl">
			choice<span class="text-amber-300">.</span>tools
		</h1>
	</header>
